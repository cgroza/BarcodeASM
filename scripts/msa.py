...
if __name__ == '__main__':
    ...
    parser.add_argument("--contigs", metavar="contigs", type = str, nargs = 1,
                        help = "Input contigs for MSA generated by BarcodeAsm")
    parser.add_argument("--out_cons", metavar="out_cons", type = str, nargs = 1,
                        help = "Output path for consensus sequences.")
    parser.add_argument("--out_msa", metavar="out_msa", type = str, nargs = 1,
                        help = "Output directory for MSAs.")
    parser.add_argument("--muscle", metavar="muscle", type = str, nargs = 1,
                        help = "Output directory for MSAs.")
